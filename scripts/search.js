(function(root) {
    ...
    function eAutocomplete(el, options) {
        var noop = function () { },
            that = this,
            defaults = {
                ajaxSettings: {},
                ...
                deferRequestBy: 0,
                params: {},
                formatResult: eAutocomplete.formatResult,
                delimiter: null,
                zIndex: 9999,
                type: 'GET',
                noCache: false,
    ...
    eAutocomplete.utils = utils;

    eAutocomplete.formatResult = function (suggestion, currentValue) {
        var pattern = '(' + utils.escapeRegExChars(currentValue) + ')';

        return suggestion.value.replace(new RegExp(pattern, 'gi'), '<strong>$1<\/strong>');
    };

    eAutocomplete.prototype = {
    ...
    if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
        ...
        // referenced as the "eAutocomplete" module.
        define(function() {
    ...
    // Expose as global:
    root.eAutocomplete = eAutocomplete;
